...
class AddressSuggestions extends Component {
  ...
  onSubmitAddress() {
    ...
    const { firstName, lastName, emailOptIn, logonId, logonPassword, logonPasswordVerify } = formStates;

    if (this.state.selectedAddress === 0) {
      console.log(formStates, 'lll');
      ...
      selectedAddress = {
        firstName, lastName, emailOptIn, logonId, logonPassword, logonPasswordVerify, 
        address : {
          addressLine1: address, zipCode: zipcode, city, state
        }
      };
    }
      ...
      >
        <div className={` ${this.state.selectedAddress === index + 1 ? suggestAddress('#0055a6') : suggestAddress()} d-flex flex-row p-2  mb-1`}>
          <div className="d-flex flex-column w-100">
            <p className="o-copy__16bold mb-1"> Suggested Address </p>
  ...
  render() {
    const { formStates } = this.props;
    const validateShippingAddress = this.props.validateShippingAddress.avsErrors
      ? this.props.validateShippingAddress.avsErrors.altAddresList
      : null;
    return (
      <div>
        <Modal
          ...
          <div className={containerMargin}>
            ...
            <div className="container px-2 px-md-3 pb-1">
              <div className="d-flex flex-column justify-content-center">
                <div className="pb-2">
                  <h4 className="text-uppercase text-center">Address Verification</h4>
                </div>
                <div className="pb-3">
                  <div className={` ${textStyle} o-copy__14reg text-center px-1`}>We were unable to verify your address with the postal database. Using the address you entered may cause delays receiving your order.</div>
                </div>
                <div className="pb-3 w-100">
                  ...
                  >
                    <div className={` ${this.state.selectedAddress === 0 ? suggestAddress('#0055a6') : suggestAddress()} d-flex flex-row p-2 mb-1`}>
                      <div className="d-flex flex-column w-100">
                        <p className="o-copy__16bold"> You Entered Address </p>
                        <div>
                          <div className={`${addressStyle} o-copy__16reg`}>
                            {formStates.address.addressLine1} {','}
                          </div>
                          <div className={`${addressStyle} o-copy__16reg`}>
                            {formStates.address.city} {formStates.address.state} {formStates.address.zipcode}
                          </div>
                        </div>
                        {/* <a
                          href=" #"
