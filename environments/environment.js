...
// Myaccount variables
export const basenameMyaccount = '/myaccount';
// SignIn SignUp variables
export const basenamesignInSignUp = '/signInSignUp';
// Cart variables
...
export const onCheckout = id => `/api/cart/PUT/${id}/initiate`;
export const taxService = id => `/api/taxes/order/${id}/tax`;
...
// bazaarVoice environment variable
...
// PRESCREEN Component
export const preScreenCall = prescreenCode => `api/validate/prescreencode?prescreencode=${prescreenCode}`;
...
export const FIRSTDATA_SID = 'c3e0b6b5065e999b';
