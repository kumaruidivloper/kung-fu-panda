...
export const staticAssetsBucketPath = `${staticAssetsDomain}uat1-dr_component_registry_vol`;
...
export const ENABLE_REDUX_DEV_TOOL = true;
// ***********************************************************
export const inventoryApi = '/api/inventory';
export const apporigin = 'https://uat11www.academy.com';
